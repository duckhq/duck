<template>
  <div class="mx-5 mt-5 text-red-800 dark-mode:text-red-200 border-red-800 border bg-red-100 dark-mode:bg-red-800 p-5 rounded-lg flex flex-col text-center sm:text-left sm:flex-row sm:justify-left">
