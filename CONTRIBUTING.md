...
By contributing to Duck, you assert that:

* The contribution is your own original work.
* You have the right to assign the copyright for the work (it is not owned by your employer, or
  you have been given copyright assignment in writing).
* You [license](https://github.com/duckhq/duck/blob/master/LICENSE) the contribution under the terms applied to the rest of the Duck project.
* You agree to follow the [code of conduct](https://github.com/duckhq/duck/blob/master/CODE_OF_CONDUCT.md).
 ...
 * Through GitHub, or through the [Discord chat](https://discord.gg/R6MgggG) (preferred),
   you talk about a feature you would like to see (or a bug you want fixed), and why it should be in Duck.
   * If approved through the Discord chat, ensure an accompanying GitHub issue is created with
     information and a link back to the discussion.
 * Once you get a nod from a [Duck Team member](https://github.com/duckhq?tab=members), you can start on the feature.
 * Alternatively, if a feature is on the issues list with the
   [Up For Grabs](https://github.com/duckhq/duck/labels/up-for-grabs) label,
 ...
 * You create, or update, a fork of duckhq/duck under your GitHub account.
 ...
 * Please do not update your branch from the master branch unless we ask you to. See the responding to feedback section below.
 ...
 * Once you feel it is ready, submit the pull request to the `duckhq/duck` repository against the `master` branch
 ...
 * One of the Duck team members, or one of the maintainers, will evaluate it within a
 ...
 * `git fetch upstream` (upstream would be the mainstream repo or `duckhq/duck` in this case)
 * `git checkout master`
 * `git rebase upstream/master`
 * `git checkout your-branch`
 * `git rebase master`
 * Fix any merge conflicts
 * `git push origin your-branch` (origin would be your GitHub repo or `your-github-username/duck` in this case).
...
If you reformat code or hit core functionality without an approval from a person on the Duck Team,
...
with permission and was edited to follow Duck's conventions and processes.